...
public class EditProfile extends AppCompatActivity {
    ...
    @InjectView(R.id.editblood) EditText editbgroup;
    ...
    public void editprofile()  {
        ...
        editprofile1.setEnabled(true);
       UpdateProf(newname,newpass,neweme,newnic,newblood);
    }
    ...
    public boolean validate() {
        ...
        String blood = editbgroup.getText().toString();
    ...
    public String UpdateProf(String name, String password, String emergency, String nic, String blood){
        ...
        proceedEdit.execute(name,password,emergency,nic,blood,reporter,reporterhash);
        return null;
    }
